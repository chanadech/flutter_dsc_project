...
class AuthenticationGuest extends StatefulWidget {
  ...
  @override
  AuthenticationGuestState createState() => AuthenticationGuestState();
}

class AuthenticationGuestState extends State<AuthenticationGuest> {
  String code;
  bool loaded;
  bool shake;
  bool valid;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text(
                "Please enter the student's passcode",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
